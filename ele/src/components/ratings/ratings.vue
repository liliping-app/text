<template>
  <div class="ratings" ref="ratings">
    <div class="ratings-content">
     ...
     <!--  <ratingselect :desc="desc" :selectType="selectType" :ratings="ratings" :onlyContent="onlyContent"></ratingselect> -->
        ...
        <ul>
          ...
          <div class="content">
            ...
            <div class="recommend" v-show="rating.recommend && rating.recommend.length">
              <span class="icon iconfont icon-haoping icon-thumb_up"></span>
...
<script>
  ...
  export default {
    ...
    created() {
     ...
     //    });
     //  });
      // this.ratings = config.seller.ratings;
    },
    methods: {
      needShow(type, text) {
